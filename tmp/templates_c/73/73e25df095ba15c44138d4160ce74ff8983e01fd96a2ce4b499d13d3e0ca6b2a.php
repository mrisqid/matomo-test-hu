...
class __TwigTemplate_606b5a86d1a2c0a32fb3552f686d2893b0a739cdd281e5e75f5a075c16d0783f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dateCountPair"]) {
            ...
            echo "\"
              ";
            // line 6
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["counts"]) || array_key_exists("counts", $context) ? $context["counts"] : (function () { throw new RuntimeError('Variable "counts" does not exist.', 6, $this->source); })()), "count", [], "any", false, false, false, 6), 0))) {
                echo "title=\"";
                ...
                echo "\"
              ";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source,             // line 7
...
";
            ...
            // line 11
            if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["counts"]) || array_key_exists("counts", $context) ? $context["counts"] : (function () { throw new RuntimeError('Variable "counts" does not exist.', 11, $this->source); })()), "starred", [], "any", false, false, false, 11), 0))) {
                echo "starred";
            }
            echo "\"></span>
        </span>
...
", "@Annotations/getEvolutionIcons.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Annotations\\templates\\getEvolutionIcons.twig");
    }
}
