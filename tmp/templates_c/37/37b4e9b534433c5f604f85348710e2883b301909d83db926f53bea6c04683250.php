...
class __TwigTemplate_65923e4102122058d2f6e7fa6092e4ec6b67476dd3ec685aa478ae7f3be7d826 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_sparklineEvolution($__evolution__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 5
            echo "    ";
            if ((-1 === twig_compare((isset($context["compareValue"]) || array_key_exists("compareValue", $context) ? $context["compareValue"] : (function () { throw new RuntimeError('Variable "compareValue" does not exist.', 5, $this->source); })()), 0))) {
                // line 6
                echo "        ";
                ...
                // line 8
                echo "    ";
            } elseif (((0 === twig_compare((isset($context["compareValue"]) || array_key_exists("compareValue", $context) ? $context["compareValue"] : (function () { throw new RuntimeError('Variable "compareValue" does not exist.', 8, $this->source); })()), 0)) || (0 === twig_compare((isset($context["compareValue"]) || array_key_exists("compareValue", $context) ? $context["compareValue"] : (function () { throw new RuntimeError('Variable "compareValue" does not exist.', 8, $this->source); })()), "0%")))) {
                // line 9
                echo "        ";
...
{% endmacro %}
", "@CoreVisualizations/macros.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\CoreVisualizations\\templates\\macros.twig");
    }
}
