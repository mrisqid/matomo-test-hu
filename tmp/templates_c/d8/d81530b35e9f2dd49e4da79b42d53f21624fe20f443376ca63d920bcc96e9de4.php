...
class __TwigTemplate_592e44901c67b23f48ca25f27a7e77796bb7c0e8e440942a571ca8802da6d43b extends Template
{
    private $source;
    private $macros = [];
    ...
    <p title=\"";
        // line 2
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Tour_StatusLevel", twig_get_attribute($this->env, $this->source, (isset($context["level"]) || array_key_exists("level", $context) ? $context["level"] : (function () { throw new RuntimeError('Variable "level" does not exist.', 2, $this->source); })()), "currentLevelName", [], "any", false, false, false, 2), twig_get_attribute($this->env, $this->source, (isset($context["level"]) || array_key_exists("level", $context) ? $context["level"] : (function () { throw new RuntimeError('Variable "level" does not exist.', 2, $this->source); })()), "challengesNeededForNextLevel", [], "any", false, false, false, 2), twig_get_attribute($this->env, $this->source, (isset($context["level"]) || array_key_exists("level", $context) ? $context["level"] : (function () { throw new RuntimeError('Variable "level" does not exist.', 2, $this->source); })()), "nextLevelName", [], "any", false, false, false, 2)]), "html_attr");
        echo "\">
    ";
        // line 3
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            if ((0 <= twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["level"]) || array_key_exists("level", $context) ? $context["level"] : (function () { throw new RuntimeError('Variable "level" does not exist.', 4, $this->source); })()), "currentLevel", [], "any", false, false, false, 4), $context["i"]))) {
                echo "successStar";
            } else {
                echo "upgradeStar";
            }
        ...
        <ul>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["challenge"]) {
                ...
                if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["challenge"], "url", [], "any", false, false, false, 31))) {
                    // line 32
                    echo "                        <a href=\"";
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('safelink')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["challenge"], "url", [], "any", false, false, false, 32)]), "html_attr");
...
";
    ...
    {
        return array (  214 => 59,  206 => 54,  199 => 50,  195 => 48,  183 => 46,  178 => 45,  175 => 44,  163 => 42,  161 => 41,  156 => 38,  149 => 36,  143 => 34,  135 => 32,  132 => 31,  124 => 29,  118 => 27,  116 => 26,  110 => 25,  106 => 24,  99 => 20,  95 => 18,  88 => 17,  82 => 14,  78 => 13,  72 => 10,  67 => 9,  65 => 8,  61 => 6,  48 => 4,  44 => 3,  40 => 2,  37 => 1,);
    }
...
", "@Tour/engagement.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Tour\\templates\\engagement.twig");
    }
}
