...
/* @CoreHome/_menu.twig */
class __TwigTemplate_38b9965bfb314ce7d41f0506e1f4c67838004caa0e6c4dca0b614ab3c454c8ac extends Template
{
    private $source;
    private $macros = [];
        ...
        <ul class=\"navbar ";
            ...
            foreach ($context['_seq'] as $context["level1"] => $context["level2"]) {
                ...
                foreach ($context['_seq'] as $context["name"] => $context["urlParameters"]) {
                    // line 9
                    echo "                    ";
                    if ((0 !== twig_compare(twig_slice($this->env, $context["name"], 0, 1), "_"))) {
                        // line 10
                        echo "                        ";
                ...
                if ((isset($context["hasSubmenuItem"]) || array_key_exists("hasSubmenuItem", $context) ? $context["hasSubmenuItem"] : (function () { throw new RuntimeError('Variable "hasSubmenuItem" does not exist.', 14, $this->source); })())) {
                    ...
                    foreach ($context['_seq'] as $context["name"] => $context["urlParameters"]) {
                        ...
                        if ((0 !== twig_compare(twig_slice($this->env, $context["name"], 0, 1), "_"))) {
                            // line 25
                            echo "                                    ";
                            $context["isActive"] = (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, true, false, 25), "module", [], "any", true, true, false, 25) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, false, false, 25), "module", [], "any", false, false, false, 25), (isset($context["currentModule"]) || array_key_exists("currentModule", $context) ? $context["currentModule"] : (function () { throw new RuntimeError('Variable "currentModule" does not exist.', 25, $this->source); })())))) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, true, false, 25), "action", [], "any", true, true, false, 25)) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, false, false, 25), "action", [], "any", false, false, false, 25), (isset($context["currentAction"]) || array_key_exists("currentAction", $context) ? $context["currentAction"] : (function () { throw new RuntimeError('Variable "currentAction" does not exist.', 25, $this->source); })()))));
                            // line 26
                            echo "                                    ";
...
{% endmacro %}
", "@CoreHome/_menu.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\CoreHome\\templates\\_menu.twig");
    }
}
