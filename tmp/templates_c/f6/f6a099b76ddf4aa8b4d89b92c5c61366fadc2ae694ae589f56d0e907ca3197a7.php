...
class __TwigTemplate_ae5a4cd30f500038ca699c24850819422e153920fb109d8acc049132f1752bf7 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 4
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reports"]) || array_key_exists("reports", $context) ? $context["reports"] : (function () { throw new RuntimeError('Variable "reports" does not exist.', 4, $this->source); })()), "getColumns", [], "any", false, false, false, 4)), 0))) {
            // line 5
    ...
    ";
        ...
        <div class=\"pk-emptyDataTable\"
            ...
            ";
            // line 34
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Insights_NoResultMatchesCriteria"]), "html", null, true);
            echo "
        </div>
    ...
    {% endif %}
</div>", "@Insights/overviewWidget.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Insights\\templates\\overviewWidget.twig");
    }
}
