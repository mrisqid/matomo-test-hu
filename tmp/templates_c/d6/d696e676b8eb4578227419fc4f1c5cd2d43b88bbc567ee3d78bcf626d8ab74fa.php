...
class __TwigTemplate_5dc27e4401ab2152eafc5c2c84828102a6568fad02b55a20b34caf69b902495f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            <div title=\"";
                ...
                echo " ";
                if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["visitor"], "getColumn", [0 => "visitDuration"], "method", false, false, false, 15), 0))) {
                    echo "(";
                ...
                if ( !twig_test_empty(((twig_get_attribute($this->env, $this->source, $context["visitor"], "getColumn", [0 => "userId"], "method", true, true, false, 16)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, $context["visitor"], "getColumn", [0 => "userId"], "method", false, false, false, 16), false)) : (false)))) {
                    ...
                    echo "\">
                        <span>";
                    // line 18
                    echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["visitor"], "getColumn", [0 => "userId"], "method", false, false, false, 18)]);
                    echo "</span>
                    </a>
                ";
                }
                ...
                ";
                // line 23
                if ( !(isset($context["userIsAnonymous"]) || array_key_exists("userIsAnonymous", $context) ? $context["userIsAnonymous"] : (function () { throw new RuntimeError('Variable "userIsAnonymous" does not exist.', 23, $this->source); })())) {
                    // line 24
                    echo "                <a class=\"visits-live-launch-visitor-profile rightLink\" title=\"";
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Live_ViewVisitorProfile"]), "html", null, true);
                    echo " ";
            ...
            <div id=\"";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                    // line 39
                    echo "                    ";
                    if ((0 >= twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 39), (isset($context["maxPagesDisplayedByVisitor"]) || array_key_exists("maxPagesDisplayedByVisitor", $context) ? $context["maxPagesDisplayedByVisitor"] : (function () { throw new RuntimeError('Variable "maxPagesDisplayedByVisitor" does not exist.', 39, $this->source); })())))) {
                        // line 40
                        echo "
                        ";
                        // line 41
                        if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 41), "ecommerceOrder")) || (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 41), "ecommerceAbandonedCart")))) {
                            // line 42
                            echo "                            ";
                            ob_start();
                            // line 43
                            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 43), "ecommerceOrder"))) {
                                // line 44
 ...
 - ";
                            // line 49
                            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 49), "ecommerceOrder"))) {
                                // line 50
                                ...
                                // line 55
                                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Goals_LeftInCart", (isset($context["revenueLeft"]) || array_key_exists("revenueLeft", $context) ? $context["revenueLeft"] : (function () { throw new RuntimeError('Variable "revenueLeft" does not exist.', 55, $this->source); })())]), "html", null, true);
                                echo ":";
                            }
                            // line 56
                            echo " ";
                            echo call_user_func_array($this->env->getFilter('money')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["action"], "revenue", [], "any", false, false, false, 56), (isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 56, $this->source); })())]);
                            // line 58
                            echo "
 - ";
...
# ";
                                    ...
                                    echo ": ";
                                    echo call_user_func_array($this->env->getFilter('money')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 62), (isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 62, $this->source); })())]);
                                }
...
\t\t\t\t\t\t        <img class='iconPadding' src=\"";
                            ...
                            echo "\"/>
                                ";
                            // line 68
                            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 68), "ecommerceOrder"))) {
                                // line 69
                                echo "                                    ";
                                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_ColumnRevenue"]), "html", null, true);
                                echo ": ";
                                echo call_user_func_array($this->env->getFilter('money')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["action"], "revenue", [], "any", false, false, false, 69), (isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 69, $this->source); })())]);
                                echo "
                                ";
                            }
                            // line 71
                        ...
                        ";
                            ...
                            if ((twig_get_attribute($this->env, $this->source, $context["action"], "url", [], "any", true, true, false, 75) &&  !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["action"], "url", [], "any", false, false, false, 75)))) {
                                // line 76
                                echo "                            <a href=\"";
                                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('safelink')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["action"], "url", [], "any", false, false, false, 76)]), "html_attr");
                                echo "\" target=\"_blank\" rel=\"noreferrer noopener\">
                            ";
                            }
                            // line 78
                            echo "                                ";
                            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 78), "action"))) {
                                // line 80
                                ob_start();
                                // line 81
...
";
                                ...
                                if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["action"], "pageTitle", [], "any", false, false, false, 83))) {
                                    ...
                                    echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["action"], "pageTitle", [], "any", false, false, false, 83)]);
                                    echo "</span>";
                                }
                                // line 84
                                echo "
...
$context["action"], "type", [], "any", false, false, false, 89), "outlink")) || (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 89), "download")))) {
                                // line 90
                                echo "                                    <img class='iconPadding' src=\"";
...
$context["action"], "type", [], "any", false, false, false, 98), "goal")) || (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 98), twig_constant("Piwik\\Piwik::LABEL_ID_GOAL_IS_ECOMMERCE_ORDER")))) || (0 === twig_compare(twig_get_attribute($this->env, $this->source,                             // line 99
$context["action"], "type", [], "any", false, false, false, 99), twig_constant("Piwik\\Piwik::LABEL_ID_GOAL_IS_ECOMMERCE_CART"))))) {
                                ...
                                echo " - ";
                                if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "revenue", [], "any", false, false, false, 101), 0))) {
                                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_ColumnRevenue"]), "html", null, true);
                                    echo ": ";
                                    echo call_user_func_array($this->env->getFilter('money')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["action"], "revenue", [], "any", false, false, false, 101), (isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 101, $this->source); })())]);
                                    echo " - ";
                                }
                                echo " ";
                ...
                ";
                // line 110
                if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitor"], "getColumn", [0 => "actionDetails"], "method", false, false, false, 110)), (isset($context["maxPagesDisplayedByVisitor"]) || array_key_exists("maxPagesDisplayedByVisitor", $context) ? $context["maxPagesDisplayedByVisitor"] : (function () { throw new RuntimeError('Variable "maxPagesDisplayedByVisitor" does not exist.', 110, $this->source); })())))) {
                    // line 111
                    echo "                    (";
...
{% endif %}
", "@Live/getLastVisitsStart.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Live\\templates\\getLastVisitsStart.twig");
    }
}
