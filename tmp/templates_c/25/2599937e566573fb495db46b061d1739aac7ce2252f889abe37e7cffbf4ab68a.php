...
/* contentBlock.twig */
class __TwigTemplate_4f39382c5c427ed6ec25fd7b648b599aecc8f5941cf8a3e93fed9e89d4f7c314 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-content\">
        ...
        if ((array_key_exists("title", $context) && (isset($context["title"]) || array_key_exists("title", $context) ? $context["title"] : (function () { throw new RuntimeError('Variable "title" does not exist.', 3, $this->source); })()))) {
            ...
            echo "            <h2 class=\"card-title\"
                  ";
            // line 5
            if (((array_key_exists("rate", $context) && (isset($context["rate"]) || array_key_exists("rate", $context) ? $context["rate"] : (function () { throw new RuntimeError('Variable "rate" does not exist.', 5, $this->source); })())) && call_user_func_array($this->env->getTest('true')->getCallable(), [(isset($context["rate"]) || array_key_exists("rate", $context) ? $context["rate"] : (function () { throw new RuntimeError('Variable "rate" does not exist.', 5, $this->source); })())]))) {
...
</div>", "contentBlock.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Morpheus\\templates\\contentBlock.twig");
    }
}
