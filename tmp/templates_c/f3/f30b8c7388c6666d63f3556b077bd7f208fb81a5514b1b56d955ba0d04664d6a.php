...
class __TwigTemplate_a16c57d7eda7b48b8e55c452e5845a0eaa9582be6aa5cbcd7d2c497933c9ae98 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card generalSettingsTOCCard\">
        ...
        if ((isset($context["isGeneralSettingsAdminEnabled"]) || array_key_exists("isGeneralSettingsAdminEnabled", $context) ? $context["isGeneralSettingsAdminEnabled"] : (function () { throw new RuntimeError('Variable "isGeneralSettingsAdminEnabled" does not exist.', 16, $this->source); })())) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreAdminHome_ArchivingSettings"]), "html", null, true);
            echo "</a>
                ";
            // line 18
            if ( !(isset($context["isMultiServerEnvironment"]) || array_key_exists("isMultiServerEnvironment", $context) ? $context["isMultiServerEnvironment"] : (function () { throw new RuntimeError('Variable "isMultiServerEnvironment" does not exist.', 18, $this->source); })())) {
                ...
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreAdminHome_EmailServerSettings"]), "html", null, true);
                echo "</a>
                ";
            }
            // line 21
        ...
        if ((isset($context["customLogoEnabled"]) || array_key_exists("customLogoEnabled", $context) ? $context["customLogoEnabled"] : (function () { throw new RuntimeError('Variable "customLogoEnabled" does not exist.', 22, $this->source); })())) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreAdminHome_BrandingSettings"]), "html", null, true);
            echo "</a>
            ";
        }
        // line 25
        ...
        if ((isset($context["isDataPurgeSettingsEnabled"]) || array_key_exists("isDataPurgeSettingsEnabled", $context) ? $context["isDataPurgeSettingsEnabled"] : (function () { throw new RuntimeError('Variable "isDataPurgeSettingsEnabled" does not exist.', 25, $this->source); })())) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["PrivacyManager_DeleteDataSettings"]), "html", null, true);
            echo "</a>
            ";
        }
        // line 28
        echo "            ";
        echo call_user_func_array($this->env->getFunction('postEvent')->getCallable(), ["Template.endGeneralSettingsPageTableOfContents"]);
        echo "
        </div>
    </div>
...
";
        ...
        enable-browser-trigger-archiving=\"";
            // line 35
            echo \Piwik\piwik_escape_filter($this->env, json_encode((0 === twig_compare((isset($context["enableBrowserTriggerArchiving"]) || array_key_exists("enableBrowserTriggerArchiving", $context) ? $context["enableBrowserTriggerArchiving"] : (function () { throw new RuntimeError('Variable "enableBrowserTriggerArchiving" does not exist.', 35, $this->source); })()), 1))), "html_attr");
            echo "\"
...
{% endblock %}
", "@CoreAdminHome/generalSettings.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\CoreAdminHome\\templates\\generalSettings.twig");
    }
}
