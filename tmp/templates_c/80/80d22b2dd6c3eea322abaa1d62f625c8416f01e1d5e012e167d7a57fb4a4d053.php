...
class __TwigTemplate_650576916641df442a5dd5fe9e42b45ae66dfeb4457f1d1ff8d008674419e7c0 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"dropdown positionInViewport\">
    <ul class=\"submenu\">
        ...
        ";
        // line 8
        if ((1 === twig_compare(twig_length_filter($this->env, (isset($context["dashboardActions"]) || array_key_exists("dashboardActions", $context) ? $context["dashboardActions"] : (function () { throw new RuntimeError('Variable "dashboardActions" does not exist.', 8, $this->source); })())), 0))) {
            // line 9
            echo "            <li>
...
", "@Dashboard/_dashboardSettings.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Dashboard\\templates\\_dashboardSettings.twig");
    }
}
