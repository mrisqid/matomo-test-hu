...
class __TwigTemplate_ecd3af368e0ce2bcbd889e0cb36becee6532e2312b49a39edd6f91ce2d7b6673 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        if ((0 === twig_compare((isset($context["numFailures"]) || array_key_exists("numFailures", $context) ? $context["numFailures"] : (function () { throw new RuntimeError('Variable "numFailures" does not exist.', 2, $this->source); })()), 0))) {
            // line 3
    ...
    {% endif %}
</div>", "@CoreAdminHome/getTrackingFailures.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\CoreAdminHome\\templates\\getTrackingFailures.twig");
    }
}
