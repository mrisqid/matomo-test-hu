...
class __TwigTemplate_3c29ebe614f873028d2e9e89eefdb65aa6ab9f9a9113f37322063bca8f9e4fcc extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <section class=\"loginSection row\">
        ...
        // line 36
        echo "        ";
        if (((array_key_exists("isValidHost", $context) && array_key_exists("invalidHostMessage", $context)) && (0 === twig_compare((isset($context["isValidHost"]) || array_key_exists("isValidHost", $context) ? $context["isValidHost"] : (function () { throw new RuntimeError('Variable "isValidHost" does not exist.', 36, $this->source); })()), false)))) {
            // line 37
            echo "            ";
...
{% endblock %}
", "@Login/loginLayout.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Login\\templates\\loginLayout.twig");
    }
}
