...
class __TwigTemplate_ed24001b40820214321dd22261daa309193b53f46263aefb259f72c4f7445a1f extends Template
{
    private $source;
    private $macros = [];
...
<div piwik-content-block
    ...
    <p>
        ...
        if ((isset($context["ignoreCookieSet"]) || array_key_exists("ignoreCookieSet", $context) ? $context["ignoreCookieSet"] : (function () { throw new RuntimeError('Variable "ignoreCookieSet" does not exist.', 33, $this->source); })())) {
            // line 34
            echo "            ";
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["UsersManager_YourVisitsAreIgnoredOnDomain", "<strong>", (isset($context["piwikHost"]) || array_key_exists("piwikHost", $context) ? $context["piwikHost"] : (function () { throw new RuntimeError('Variable "piwikHost" does not exist.', 34, $this->source); })()), "</strong>"]);
            echo "
        ";
        } else {
            // line 36
    ...
    <a href='";
        ...
        ";
            ...
            // line 41
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["UsersManager_ClickHereToSetTheCookieOnDomain", (isset($context["piwikHost"]) || array_key_exists("piwikHost", $context) ? $context["piwikHost"] : (function () { throw new RuntimeError('Variable "piwikHost" does not exist.', 41, $this->source); })())]), "html", null, true);
        }
        // line 42
        echo "        <br/>
    </a></span>
...
{% endblock %}
", "@UsersManager/userSettings.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\UsersManager\\templates\\userSettings.twig");
    }
}
