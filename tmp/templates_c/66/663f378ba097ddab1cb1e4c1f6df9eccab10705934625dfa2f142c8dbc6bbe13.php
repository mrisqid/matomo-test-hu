...
class __TwigTemplate_d4c005ff49bc555321c58d277205ef8b90e7434827268c9d576ecb04cdc3d8b7 extends Template
{
    private $source;
    private $macros = [];
...
";
            // line 5
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["PagePerformance_PageLoadTime"]), "html", null, true);
            echo ": ";
...
";
            // line 15
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Actions_ColumnSearchCategory"]), "html", null, true);
            echo ": ";
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 15, $this->source); })()), "siteSearchCategory", [], "any", false, false, false, 15)]);
        }
        // line 16
...
";
            // line 18
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Actions_ColumnSearchResultsCount"]), "html", null, true);
            echo ": ";
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 18, $this->source); })()), "siteSearchCount", [], "any", false, false, false, 18)]);
        }
    }
...
{{ 'Actions_ColumnSearchResultsCount'|translate }}: {{ action.siteSearchCount|rawSafeDecoded }}{% endif %}", "@Live/_actionTooltip.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Live\\templates\\_actionTooltip.twig");
    }
}
