...
class __TwigTemplate_cbb4d449c6a039b28e66dca839261cc5e1b0f1e401de082649ae90346b6b0ce1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table cellspacing=\"0\" class=\"dataTable\">
        ...
        <tbody>";
            ...
            // line 15
            if (((isset($context["showingEmbeddedSubtable"]) || array_key_exists("showingEmbeddedSubtable", $context) ? $context["showingEmbeddedSubtable"] : (function () { throw new RuntimeError('Variable "showingEmbeddedSubtable" does not exist.', 15, $this->source); })()) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["dataTable"]) || array_key_exists("dataTable", $context) ? $context["dataTable"] : (function () { throw new RuntimeError('Variable "dataTable" does not exist.', 15, $this->source); })()), "getRowsCount", [], "method", false, false, false, 15), 0)))) {
                // line 16
                echo "            ";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["rowId"] => $context["row"]) {
                    ...
                    // line 26
                    $context["isSummaryRow"] = ((0 === twig_compare($context["rowId"], twig_constant("Piwik\\DataTable::ID_SUMMARY_ROW"))) || twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", [0 => "is_summary"], "method", false, false, false, 26));
                    // line 27
...
($context["properties"] ?? null), "replace_row_with_subtable", [], "any", true, true, false, 34)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["properties"] ?? null), "replace_row_with_subtable", [], "any", false, false, false, 34), false)) : (false)));
                    ...
                    ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                            ...
                            // line 45
                            echo "                        <td class=\"";
                            if (((0 === twig_compare($context["column"], "label")) || twig_in_filter($context["column"], (isset($context["dimensions"]) || array_key_exists("dimensions", $context) ? $context["dimensions"] : (function () { throw new RuntimeError('Variable "dimensions" does not exist.', 45, $this->source); })())))) {
                                echo "label";
                            } else {
                                echo "column";
                            }
                            ...
                            ";
                            // line 48
                            if (((isset($context["isComparing"]) || array_key_exists("isComparing", $context) ? $context["isComparing"] : (function () { throw new RuntimeError('Variable "isComparing" does not exist.', 48, $this->source); })()) && (0 === twig_compare($context["column"], "label")))) {
                                // line 49
...
(isset($context["dimensions"]) || array_key_exists("dimensions", $context) ? $context["dimensions"] : (function () { throw new RuntimeError('Variable "dimensions" does not exist.', 62, $this->source); })())]));
                ...
                if ((twig_get_attribute($this->env, $this->source, (isset($context["dataTable"]) || array_key_exists("dataTable", $context) ? $context["dataTable"] : (function () { throw new RuntimeError('Variable "dataTable" does not exist.', 74, $this->source); })()), "getTotalsRow", [], "any", false, false, false, 74) && twig_get_attribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 74, $this->source); })()), "show_totals_row", [], "any", false, false, false, 74))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                        // line 80
                        echo "                        <td class=\"";
                        if ((0 === twig_compare($context["column"], "label"))) {
                            echo "label";
                        } else {
                            echo "column";
                        }
...
{% else %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\CoreVisualizations\\templates\\_dataTableViz_htmlTable.twig");
    }
}
