...
class __TwigTemplate_166774016bfdcec6b89c122aead4b6cfe355cc74318a730c4303aa78a063f21a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 1, $this->source); })()), "getColumn", [0 => "visitorType"], "method", false, false, false, 1), "new"))) {
...
";
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 4, $this->source); })()), "getColumn", [0 => "visitIp"], "method", false, false, false, 4))) {
            ...
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 5, $this->source); })()), "getColumn", [0 => "userId"], "method", false, false, false, 5))) {
                ...
                echo ": ";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 5, $this->source); })()), "getColumn", [0 => "userId"], "method", false, false, false, 5)]);
                echo "
";
            }
            // line 6
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 6, $this->source); })()), "getColumn", [0 => "visitorId"], "method", false, false, false, 6))) {
...
";
    ...
    ";
            // line 15
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 15, $this->source); })()), "getColumn", [0 => "location"], "method", false, false, false, 15), call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_Unknown"])))) {
    ...
    ";
            ...
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 18, $this->source); })()), "getColumn", [0 => "userId"], "method", false, false, false, 18))) {
                echo "<br/><br/>";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 18, $this->source); })()), "getColumn", [0 => "userId"], "method", false, false, false, 18)]);
            }
            // line 19
            echo "</span>";
        }
    ...
    ";
            // line 22
            echo call_user_func_array($this->env->getFunction('postEvent')->getCallable(), ["Live.renderVisitorIcons", (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 22, $this->source); })())]);
            echo "
";
        }
    }
...
{% endif %}
", "@Live/_visitorDetails.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Live\\templates\\_visitorDetails.twig");
    }
}
