...
class __TwigTemplate_73e0ca74654ce976ecda1005b9a91b1d553402e54ecfe4ffbee245aab9b08878 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((isset($context["numErrors"]) || array_key_exists("numErrors", $context) ? $context["numErrors"] : (function () { throw new RuntimeError('Variable "numErrors" does not exist.', 6, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["thisResult"]) {
                ...
                // line 10
                echo "                ";
                if ((twig_test_empty(twig_get_attribute($this->env, $this->source, $context["thisResult"], "getLongErrorMessage", [], "any", false, false, false, 10)) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["thisResult"], "getItems", [], "method", false, false, false, 10)), 1)))) {
                    // line 11
                    echo "                    ";
                    $context['_parent'] = $context;
    ...
    ";
        ...
        if ((isset($context["numWarnings"]) || array_key_exists("numWarnings", $context) ? $context["numWarnings"] : (function () { throw new RuntimeError('Variable "numWarnings" does not exist.', 22, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["thisResult"]) {
                ...
                // line 26
                echo "                ";
                if ((twig_test_empty(twig_get_attribute($this->env, $this->source, $context["thisResult"], "getLongErrorMessage", [], "any", false, false, false, 26)) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["thisResult"], "getItems", [], "method", false, false, false, 26)), 1)))) {
                    // line 27
                    echo "                    ";
                    $context['_parent'] = $context;
...
</div>", "@Installation/getSystemCheckWidget.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Installation\\templates\\getSystemCheckWidget.twig");
    }
}
