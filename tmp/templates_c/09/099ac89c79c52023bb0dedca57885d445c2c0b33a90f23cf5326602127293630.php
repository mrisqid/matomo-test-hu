...
class __TwigTemplate_93a1d9a5b8d5da6fd3394a749429433b14febe3d0558f39c6cdfc8269b04e007 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        ...
        if ( !twig_test_empty(((twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "pageTitle", [], "any", true, true, false, 5)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "pageTitle", [], "any", false, false, false, 5), false)) : (false)))) {
            ...
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 6, $this->source); })()), "pageTitle", [], "any", false, false, false, 6)]);
            echo "</span>
        ";
        }
        // line 8
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "siteSearchKeyword", [], "any", true, true, false, 8)) {
            // line 9
            echo "            ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 9, $this->source); })()), "type", [], "any", false, false, false, 9), "search"))) {
                // line 10
                echo "                <img src='";
            ...
            // line 13
            echo "            <span class=\"truncated-text-line\">";
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 13, $this->source); })()), "siteSearchKeyword", [], "any", false, false, false, 13)]);
            echo "</span>
        ";
        }
        // line 15
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 15, $this->source); })()), "url", [], "any", false, false, false, 15))) {
            ...
            // line 19
            echo "            ";
            if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 19, $this->source); })()), "type", [], "any", false, false, false, 19), "action")) &&  !twig_test_empty(((twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "pageTitle", [], "any", true, true, false, 19)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "pageTitle", [], "any", false, false, false, 19), false)) : (false))))) {
                echo "<p>";
            }
            // line 20
            echo "            ";
...
(isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 22, $this->source); })()), "url", [], "any", false, false, false, 22)))) && is_string($__internal_compile_5 = "data:") && ('' === $__internal_compile_5 || 0 === strpos($__internal_compile_4, $__internal_compile_5))))) {
            ...
            ";
                ...
                // line 25
                echo "                <a href=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('safelink')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 25, $this->source); })()), "url", [], "any", false, false, false, 25)]), "html_attr");
            ...
            // line 35
            echo "            ";
            if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 35, $this->source); })()), "type", [], "any", false, false, false, 35), "action")) &&  !twig_test_empty(((twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "pageTitle", [], "any", true, true, false, 35)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "pageTitle", [], "any", false, false, false, 35), false)) : (false))))) {
                echo "</p>";
            }
            // line 36
            echo "        ";
        } elseif ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 36, $this->source); })()), "type", [], "any", false, false, false, 36), "search"))) {
            // line 37
            echo "            <p>
                <span>";
            // line 38
...
", "@Live/_actionCommon.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\Live\\templates\\_actionCommon.twig");
    }
}
