...
class __TwigTemplate_cbf3f056a09ef101213c81d6c1a6367fe2df0d981697d688c2c9c3989f07ff80 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        // line 13
        echo "            ";
        if ((0 === twig_compare(twig_length_filter($this->env, (isset($context["sparklines"]) || array_key_exists("sparklines", $context) ? $context["sparklines"] : (function () { throw new RuntimeError('Variable "sparklines" does not exist.', 13, $this->source); })())), 1))) {
            // line 14
            echo "            ";
            $context['_parent'] = $context;
    ...
    ";
        ...
        echo "
            ";
        // line 37
        if ((0 === twig_compare(twig_length_filter($this->env, (isset($context["sparklines"]) || array_key_exists("sparklines", $context) ? $context["sparklines"] : (function () { throw new RuntimeError('Variable "sparklines" does not exist.', 37, $this->source); })())), 1))) {
            // line 38
            echo "            ";
            $context['_parent'] = $context;
...
{% endif %}", "@CoreVisualizations/_dataTableViz_sparklines.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\CoreVisualizations\\templates\\_dataTableViz_sparklines.twig");
    }
}
