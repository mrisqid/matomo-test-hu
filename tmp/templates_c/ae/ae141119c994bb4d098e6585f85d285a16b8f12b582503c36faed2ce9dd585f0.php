...
class __TwigTemplate_5286e7c7bd2f3308e64dcad8d1b108b1c53b359f85cd5b57103361b3fd2cb4ce extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"UserCountryMap card-content\" style=\"position:relative; overflow:hidden;\">
    ...
    <div class=\"mapWidgetStatus\">
        ...
        if ((isset($context["noData"]) || array_key_exists("noData", $context) ? $context["noData"] : (function () { throw new RuntimeError('Variable "noData" does not exist.', 22, $this->source); })())) {
            ...
            if ( !(isset($context["isWidget"]) || array_key_exists("isWidget", $context) ? $context["isWidget"] : (function () { throw new RuntimeError('Variable "isWidget" does not exist.', 23, $this->source); })())) {
                // line 24
                echo "            <h2>";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["UserCountryMap_VisitorMap"]), "html", null, true);
                echo "</h2>
            ";
            }
            // line 26
    ...
    ";
        ...
        if ( !(isset($context["noData"]) || array_key_exists("noData", $context) ? $context["noData"] : (function () { throw new RuntimeError('Variable "noData" does not exist.', 34, $this->source); })())) {
            // line 35
            echo "    <div class=\"dataTableFeatures\" style=\"padding-top:0;\">
        <div class=\"dataTableFooterIcons\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["metric"]) {
                ...
                echo "\" ";
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["metric"], 0, [], "array", false, false, false, 64), (isset($context["defaultMetric"]) || array_key_exists("defaultMetric", $context) ? $context["defaultMetric"] : (function () { throw new RuntimeError('Variable "defaultMetric" does not exist.', 64, $this->source); })())))) {
...
{% endif %}
", "@UserCountryMap/visitorMap.twig", "C:\\xampp\\htdocs\\matomo\\plugins\\UserCountryMap\\templates\\visitorMap.twig");
    }
}
